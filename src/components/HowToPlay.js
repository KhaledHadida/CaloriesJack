...
function HowToPlay() {
    return (
        <div className="flex flex-col  items-center h-full">
            <h1 className="text-8xl mb-14">How to play? Simple.</h1>
            ...
            <p className="font-semibold mt-14">Note: Please play with a friend, you can play alone but it's not as fun (nor was it intended)</p>
            <p className="italic font-bold">..Have fun!</p>
        </div>
    );
}
